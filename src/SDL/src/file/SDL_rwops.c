...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_rwops.c,v 1.3.2.8 2001/02/10 07:20:04 hercules Exp $";
#endif
...
SDL_RWops *SDL_RWFromFile(const char *file, const char *mode)
{
    ...
    // SDL_TRACE1("SDL: SDL_RWFromFile: opening file %s", file); //!!SymbianOS
...
#endif
	if ( fp == NULL ) {
        // SDL_TRACE1("SDL: SDL_RWFromFile: cannot open %s", file); //!!SymbianOS
