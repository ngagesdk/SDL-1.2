...
int EPOC_VideoInit(_THIS, SDL_PixelFormat *vformat)
{
	...
	Private->SDL_modelist[0]->w = 640; Private->SDL_modelist[0]->h = 480;
	Private->SDL_modelist[1]->w = 640; Private->SDL_modelist[1]->h = 400; 
	Private->SDL_modelist[2]->w = 640; Private->SDL_modelist[2]->h = 200; 
	Private->SDL_modelist[3]->w = 320; Private->SDL_modelist[3]->h = 240;
	Private->SDL_modelist[4]->w = 320; Private->SDL_modelist[4]->h = 200;
	Private->SDL_modelist[5] = NULL;
