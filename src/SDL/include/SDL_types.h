...
//!! If 64 bit types is wanted in Epoc there should be workaround for 64 bit shifting in SDL_Swap64()!!
//!! Is this problem in ARMI build??
#ifndef __SYMBIAN32__ //!!SymbianOS
