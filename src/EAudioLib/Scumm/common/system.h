...
class MCompleteListener
    {
    public:
        virtual void completeListen(int aErr, TInt aBytesWritten) = 0;
    };

class TSystemAudioCaps
    {
    public:
        TSystemAudioCaps();
        TInt iRate;
...
public:
    ...
    virtual void setCompleteListener(MCompleteListener* listener) = 0;
    ...
    virtual void setSystemAudio(const TSystemAudioCaps& aCaps) = 0;
